            ...
            <div class="row">
                <div class="col-sm-8 pull-left">
                    <div class="title-wrap">
                        ...
                        <p class="fs-16 no-margin">Know more about us</p>
                    </div>
                </div>
                <div class="col-sm-4">
                    <ol class="breadcrumb-menubar list-inline">
                        <li><a href="index-2.html" class="gray-clr">Home</a></li>
                        ...
                        <ul class="feature">
                            <li>
                                <div class="feature-content wow rotateInDownRight" data-wow-offset="50" data-wow-delay=".30s">
                                    <h2 class="title-1">Express Delivery</h2>
                                    <p>We guarantee speedy same day and next-day delivery within Lagos, no matter the weather or situation, our in-city bike delivery ensures there's no delay between you and your delivered or expected package. We ensure careful and secure handling of packages which are picked and delivered on agreed schedules.</p>
                                </div>
                            </li>
                        </ul>
                    </div>
