            ...
            <div class="row">
                <div class="col-sm-8 pull-left">
                    <div class="title-wrap">
                        <h2 class="section-title no-margin">FEATURED SERVICES</h2>
                        <p class="fs-16 no-margin">Know the services we offer</p>
                    </div>
                </div>
                <div class="col-sm-4">
                ...
                <div class="col-md-4">
                    <div class="about-us pt-10">
                        ...
                        <ul style="margin-left: 20px; list-style-type: circle;">
                            <li><p>We guarantee speedy same day and next-day delivery within Lagos, no matter the weather or situation, our in-city bike delivery ensures there's no delay between you and your delivered or expected package. We ensure careful and secure handling of packages which are picked and delivered on agreed schedules.</p></li>
                        </ul>
                    </div>
                </div>
            </div>
